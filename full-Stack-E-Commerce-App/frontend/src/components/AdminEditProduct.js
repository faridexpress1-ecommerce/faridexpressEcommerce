...
const AdminEditProduct = ({
  ...
  return (   
     <div className='fixed bg-slate-900 bg-opacity-35 w-full h-full top-0 bottom-0 left-0 right-0 flex justify-center items-center'>
        <div className='bg-white p-4 rounded w-full max-w-2xl h-full max-h-[80%] overflow-hidden'>
          ...
          <div>    
              ...
              <button className='px-3 py-2 bg-slate-950 text-white mb-12 hover:bg-slate-500'>Updade Product</button>
         </form>   
