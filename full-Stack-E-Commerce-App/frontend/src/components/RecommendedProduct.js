...
const RecommendedProduct = ({category, heading}) => {
  ...
  return (
    <div className='mx-auto px-4 my-6 relative'>
       ...
       <div className="grid grid-cols-[repeat(auto-fit,minmax(300px,320px))] lg:justify-between justify-center md:gap-2 overflow-x-scroll  scroll-smooth scrollbar-none transition-all">
            {           
               loading ? (
